...
import com.catchingnow.tinyclipboardmanager.Results.ActivityAlmacenamiento;
import com.catchingnow.tinyclipboardmanager.Results.ActivityResults;
import com.catchingnow.tinyclipboardmanager.Results.ActivitySeguridad;
...
//                return super.onOptionsItemSelected(item);
            ...
            case R.id.action_delete_all:
                //startActivity(new Intent(this, clearAll());
                clearAll();
                break;
            case R.id.action_settings:
                ...
                break;
                //cancelSecondLaunch();
            case R.id.action_saber_mas:
                startActivity(new Intent(this, ActivityResults.class));
               cancelSecondLaunch();
        }
        clearDeleteQueue();
        return super.onOptionsItemSelected(item);
